...
import { KeyboardAvoidingView, SafeAreaView, StyleSheet, Text, View, Button, TextInput, TouchableHighlight, ScrollView } from 'react-native';
...
export default class AdminSignUpScreen extends Component {
    ...
    submitSignUp = () => {
        ...
        if(this.state.adminCodeInput !== 'Admin') {
